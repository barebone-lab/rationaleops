...
function outcomeLabel(decision: DemoDecision) {
...
export function Dashboard() {
  ...
  async function submitLiveAnswer(event: FormEvent) {
      ...
      <section className="workspace-grid">
        <aside className="pane impact-pane" aria-label="DataHub impact graph">
          ...
          <div className="context-list">
            ...
            <div><span>GLOSSARY</span><strong>Active Customer</strong><small>“activity within 30 days”</small></div>
